...
namespace BAF.Service.Core.Ioc
{
    public class SimpleInjectorImpl : IBAFIoc
    {
        ...
        public void Register<TService, TImplementation>(Lifetimes lifetime) where TService : class where TImplementation : class, TService
        {
            ...
            switch (lifetime)
            {
                case Lifetimes.Transient: { lifestyle = Lifestyle.Transient; break; }
                case Lifetimes.Singleton: { lifestyle = Lifestyle.Singleton; break; }
                case Lifetimes.Scoped: { lifestyle = Lifestyle.Scoped; break; }
                default: { lifestyle = Lifestyle.Transient; break; }
            }
